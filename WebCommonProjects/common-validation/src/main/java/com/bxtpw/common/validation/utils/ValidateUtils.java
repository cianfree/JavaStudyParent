package com.bxtpw.common.validation.utils;
...
public class ValidateUtils {
     ...
     * 整数
     */
    public static final String V_INT = "^-?[1-9]\\d*$";

    /**
     * 正整数
     */
    public static final String V_POSITIVE_INT = "^[1-9]\\d*$";
    ...
    public static boolean isPositiveInteger(String value) {
        return isMatch(V_POSITIVE_INT, value);
    }
    ...
    public static boolean isNegativeInteger(String value) {
        return isMatch(V_NEGATIVE_INTEGER, value);
    }
    ...
    public static boolean isPositiveNumber(String value) {
        return isMatch(V_POSITIVE_NUMBER, value);
    }
    ...
    public static boolean isNegativeNumber(String value) {
        return isMatch(V_NEGATINE_NUMBER, value);
    }
    ...
    public static boolean isChinese(String value) {
        return isMatch(V_CHINESE, value);
    }
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean ifFloat(String value) {
        return isMatch(V_FLOAT, value);
    }
    ...
    public static boolean isLowerLetter(String value) {
        return isMatch(V_LETTER_I, value);
    }
    ...
    public static boolean isUpperLetter(String value) {
        return isMatch(V_LETTER_U, value);
    }
    ...
    public static boolean isNegativeFloat(String value) {
        return isMatch(V_NEGATIVE_FLOAT, value);
    }
    ...
    public static boolean isNotBlank(String value) {
        return isMatch(V_NOTEMPTY, value);
    }
    ...
    public static boolean isPicture(String value) {
        return isMatch(V_PICTURE, value);
    }
    ...
    public static boolean isPosttiveFloat(String value) {
        return isMatch(V_POSTTIVE_FLOAT, value);
    }
    ...
    public static boolean isQQNumber(String value) {
        return isMatch(V_QQ_NUMBER, value);
    }
    ...
    public static boolean isTwoPointFloat(String value) {
        return isMatch(V_TWO＿POINT, value);
    }
    ...
    public static boolean isUnNegativeFloat(String value) {
        return isMatch(V_UN_NEGATIVE_FLOAT, value);
    }
    ...
    public static boolean isUnPositiveFloat(String value) {
        return isMatch(V_UNPOSITIVE_FLOAT, value);
    }
    ...
    public static boolean isZipcode(String value) {
        return isMatch(V_ZIPCODE, value);
    }
